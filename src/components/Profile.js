      ...
      <div className="lg:w-4/6 mx-auto" id=''>
        <div className="flex flex-col sm:flex-row mt-10  " id='profilecard'>
          <div className="sm:w-1/3 text-center sm: sm:py-8">
            <div>
              <div className="w-28 h-20 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400">
                <img className='rounded-full' src='chloeCarter.png' />
              ...
              <div className='profileChange text-3xl -mt-3'>
                ...
                <h2 className="font-medium title-font mt-4 text-gray-800 text-base">Chloe Carter</h2>
                <hr />
              </div>
          ...
          <div className="sm:w-2/3 sm:pl-8 sm:py-2 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
            ...
            <h2 className='font-base text-2xl mt-3 text-gray-900'>Profile</h2>
                ...
                <div className=" mx-">
                  <div className="flex flex-wrap -m-2">
                    ...
                    <div className="flex flex-col w-full px-5 -mb-2 mt-5">
                      <p className="lg:w-2/3 leading-relaxed text-sm">Change Your Email</p>
                    </div>
