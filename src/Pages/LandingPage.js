    ...
    return (
        <div className='bg-gradient-to-r from-[#B51BFFA6] via-[#C140FF8A] to-[#f9e5ff]'>
            ...
            <section className="text-gray-600 body-font">
                ...
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    ...
                    <div className="lg:flex-grow lg:w-10 md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-justify">
                        <h1 className="title-font sm:text-5xl text-3xl mb-4 mx-auto font-semibold text-[#620058]">Automate Your
                        </h1>
                        <h1 className="title-font sm:text-6xl text-3xl mb-4 mx-auto font-semibold text-[#FFFFFF]">Content Dubbing
                        </h1>
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 mx-auto font-semibold text-[#620058]">To 120+ Languages
                        </h1>
                    </div>

                    <div className="bg-[#FAD3FB] lg:max-w-lg lg:w-full h-[30rem] md:w-1/2 w-5/6 my-auto rounded-3xl">
                ...
                <div className="container mx-auto flex py-24 md:flex-row flex-col items-center">
                    <div className="lg:flex lg:w-fit md:w-1/2 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-justify mx-auto">
                        <h1 className="title-font sm:text-5xl text-3xl mb-4 mx-auto font-semibold text-[#620058]">Generate
                        </h1>
                        <h1 className="title-font sm:text-6xl text-3xl mb-4 mx-auto font-semibold text-[#FFFFFF]">Videos
                        </h1>
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 mx-auto font-semibold text-[#620058]">in seconds...
                        </h1>
                    </div>
                    ...
                    <div className="lg:flex lg:w-fit md:w-1/2 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-justify mx-auto">
                        <h1 className="title-font sm:text-5xl text-3xl mb-4 mx-auto font-semibold text-[#620058]">Create
                        </h1>
                        <h1 className="title-font sm:text-6xl text-3xl mb-4 mx-auto font-semibold text-[#FFFFFF]">Audios
                        </h1>
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 mx-auto font-semibold text-[#620058]">in a Snap!
                        </h1>
                    </div>
                </div>
                ...
                <section className="text-gray-600 body-font py-10">
                    <div className="container mx-auto flex px-5 pt-24 pb-12 md:flex-row flex-col items-center">
                        ...
                        <div className="lg:flex lg:w-[55%] md:w-1/2 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center mx-auto">
            ...
            <div className='w-full my-10'>
                <h2 className='w-[60%] mx-auto text-center text-6xl'>Authentic Human Voices, Powered by AI</h2>
                <p className='w-[70%] my-10 mx-auto text-center text-xl font-semibold'>Effortless Studio-Quality Voice Overs in Seconds: Create Professional Narrations in Minutes. Ubilang: Your AI Voice Partner for Podcasts, Videos, and Professional Presentations</p>

                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">

                    <div className="lg:flex-grow lg:w-10 md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-justify">
                        <h1 className="title-font sm:text-5xl text-3xl mb-4 mx-auto font-semibold text-[#620058]">The perfect voice
                        </h1>
                        <h1 className="title-font sm:text-5xl text-3xl mb-4 mx-auto font-semibold text-[#FFFFFF]"><span className='text-[#620058]'>for&nbsp;</span>every
                        </h1>
                        <h1 className="title-font sm:text-5xl text-3xl mb-4 mx-auto font-semibold text-white">occasion.
                        </h1>
                    </div>
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap">
                        {voices.map((voices) =>
                            <div className="p-10 lg:w-1/3" key={voices.id}>
                                <div style={{ backgroundColor: voices.bgColor, borderColor: voices.borderColor }} className="h-full mx-10 pt-5 rounded-lg overflow-hidden border-2 text-center relative hover:border-[#620058]">
                    ...
                    <h2 className='w-full mx-auto text-center font- my-20 text-[#4F0047] text-7xl'>
                        Snap of Studio
                    </h2>
                    <div className='w-full h-[50vh] my-20'>

                        <div className='w-full h-[50vh]'>
                            <div className='flex relative rounded-lg w-full mx-auto my-auto top-[35%] h-[25%] overflow-hidden bg-[#F87CFF]'></div>
                            <img className='absolute w-fit left-[10%] -mt-20' src='ss1.png' alt='snap' />
                            <img className='absolute w-fit left-[50%] -mt-20' src='ss2.png' alt='snap' />
                        </div>
                    </div>
            ...
            <div>
                <h2 style={{ background: "linear-gradient(90deg, #4F0047 36.72%, rgba(98, 0, 88, 0) 126.59%)", WebkitBackgroundClip: 'text', WebkitTextFillColor: "transparent" }} className='w-full mx-auto text-center text-7xl'>
                ...
                <section className="text-gray-600 body-font">
                    <div className="container px-5 py-24 mx-auto">
                        <div className="flex flex-wrap mx-auto -mb-10 text-center">
                            <div className="sm:w-1/2 mb-10 px-4 my-10 ">
                                <div className="relative rounded-lg w-[50%] mx-auto h-[70vh] overflow-hidden bg-gradient-to-r from-[#B51BFFA6] via-[#C140FF8A] to-[#f9e5ff]">
                            ...
                            <div className="sm:w-1/2 mb-10 px-4 my-10">
                                <div className="relative rounded-lg w-[50%] mx-auto h-[70vh] overflow-hidden">
                                    <div className=' relative rounded-lg w-[25%] mx-auto my-5 justify- items-center h-[55%] overflow-hidden -rotate-45 bg-[#F87CFF]'></div>
                    ...
                    <button className="flex mx-auto text-black font-semibold bg-[#D301A8] border-0 py-2 my-10 px-8 focus:outline-none hover:bg-[#F87CFF] rounded-xl text-lg">
                        Get Started
                    </button>
                </section>
            </div>
            ...
            <h2 style={{ background: "linear-gradient(90deg, #4F0047 36.72%, rgba(98, 0, 88, 0) 126.59%)", WebkitBackgroundClip: 'text', WebkitTextFillColor: "transparent" }} className='w-[75%] mx-auto my-10 text-center text-5xl'>
